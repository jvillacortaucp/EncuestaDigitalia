...
using Digitalia.Core.Services;
using Digitalia.Core.Services.Account;
using Digitalia.Core.Services.Shop;
using Digitalia.Server.Authorization;
using Digitalia.Server.Authorization.Requirements;
using Digitalia.Server.Configuration;
using Digitalia.Server.Services;
using Digitalia.Server.Services.Email;
...
if (app.Environment.IsDevelopment())
{
    ...
    app.UseSwaggerUI(c =>
    {
        c.DocumentTitle = "Swagger UI - Digitalia";
